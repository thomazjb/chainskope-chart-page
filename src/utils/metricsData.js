const metricsData = {
    ...
    "data": {
        ...
        "data": [
            ...
            {
                "id": "9822fcbc-ad1e-4478-a903-335bb9149361",
                "metric": "BURN_ERC20",
                "metric_display_name": "Burn ERC-20",
                "metric_description": "Burns of a currency (ERC-20)",
                "metric_type": "SERIES",
                "api_endpoint": "${BLOCKCHAIN_API_URL}/query",
                "created_at": "2023-11-01T12:01:48.096Z",
                "updated_at": "2023-11-01T12:01:48.096Z",
                "operations": [
                    {
                        "id": "aa0b44c0-732e-4138-8513-4dfce7bd2aa1",
                        "metric_id": "9822fcbc-ad1e-4478-a903-335bb9149361",
                        "field": "to_address",
                        "as": "total",
                        "distinct": true,
                        "operation": "COUNT",
                        "operation_name": "Unique Receivers",
                        "operation_description": "Count of unique receivers of burn transfer event logs",
                        "created_at": "2023-11-01T12:01:48.096Z",
                        "updated_at": "2023-11-01T12:01:48.096Z"
                    },
                    {
                        "id": "5990cdc8-12ec-4c6b-9460-e4ba4ad0ff21",
                        "metric_id": "9822fcbc-ad1e-4478-a903-335bb9149361",
                        "field": "from_address",
                        "as": "total",
                        "distinct": true,
                        "operation": "COUNT",
                        "operation_name": "Unique Senders",
                        "operation_description": "Count of unique senders of burn transfer event logs",
                        "created_at": "2023-11-01T12:01:48.096Z",
                        "updated_at": "2023-11-01T12:01:48.096Z"
                    },
                    {
                        "id": "292463e5-d1c7-478b-b54c-91a77519e8bc",
                        "metric_id": "9822fcbc-ad1e-4478-a903-335bb9149361",
                        "field": "volume",
                        "as": "total",
                        "distinct": false,
                    ...
                    {
                        "id": "d79d5663-7411-40d4-a26f-993d205135b8",
                        "metric_id": "9822fcbc-ad1e-4478-a903-335bb9149361",
                        "field": "volume",
                        "as": "total",
                        "distinct": false,
                    ...
                    {
                        "id": "3033ed0a-6f8d-464c-8e1b-b7335152471b",
                        "metric_id": "9822fcbc-ad1e-4478-a903-335bb9149361",
                        "field": "volume",
                        "as": "total",
                        "distinct": false,
                    ...
                    {
                        "id": "c6b7c317-b703-4396-8f42-fdeac8294cfa",
                        "metric_id": "9822fcbc-ad1e-4478-a903-335bb9149361",
                        "field": "volume",
                        "as": "total",
                        "distinct": false,
                    ...
                    {
                        "id": "15ac635a-a93b-4223-a4e4-be8321df5ed5",
                        "metric_id": "9822fcbc-ad1e-4478-a903-335bb9149361",
                        "field": "volume",
                        "as": "total",
                        "distinct": false,
                    ...
                    {
                        "id": "b7ef28e5-4cbb-4404-badd-94e43d1a1f34",
                        "metric_id": "9822fcbc-ad1e-4478-a903-335bb9149361",
                        "field": "volume",
                        "as": "total",
                        "distinct": false,
